...
public class Match {
    ...
    public Match(String player1ID, String player2ID, String winner, Player[] players, int playerCount){
        Player p1 = null;
        Player p2 = null;
        ...
        if (p1 == null) {
            p1 = new Player(player1ID, playerCount++);
        }
        if (p2 == null) {
            p2 = new Player(player2ID, playerCount++);
        }
        assert p1 != null;
        ...
        int finalRating1 = (int)Math.round(p1.getElo() + K * (score1 - expected1)); // r(1) + K * (S(1) – E(1))
